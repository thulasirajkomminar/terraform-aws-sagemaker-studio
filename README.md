...
| [aws_sagemaker_studio_lifecycle_config.codeeditor_autoshutdown](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/sagemaker_studio_lifecycle_config) | resource |
| [aws_sagemaker_studio_lifecycle_config.jupyterlab_autoshutdown](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/sagemaker_studio_lifecycle_config) | resource |
...
| <a name="input_code_editor_app_settings"></a> [code\_editor\_app\_settings](#input\_code\_editor\_app\_settings) | The Code Editor application settings | `any` | `null` | no |
| <a name="input_jupyter_lab_app_settings"></a> [jupyter\_lab\_app\_settings](#input\_jupyter\_lab\_app\_settings) | The settings for the JupyterLab application | `any` | `null` | no |
| <a name="input_jupyter_server_app_settings"></a> [jupyter\_server\_app\_settings](#input\_jupyter\_server\_app\_settings) | The Jupyter server's app settings | `any` | `null` | no |
